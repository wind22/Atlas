...
# templates/ lives at the repo root; this module now sits at atlas/site/, so go
# up three levels (atlas/site → atlas → repo root).
_TEMPLATE_DIR = pathlib.Path(__file__).resolve().parent.parent.parent / "templates"
